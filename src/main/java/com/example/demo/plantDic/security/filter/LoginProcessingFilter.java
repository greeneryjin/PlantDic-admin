package com.example.demo.plantDic.security.filter;
...
public class LoginProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        //NULL 값 확인
        if (accountApiRequest.getUserId() == null || accountApiRequest.getPassword() == null) {
            throw new IllegalArgumentException("Username or Password is Null");
        }

        //Ajax용 토큰을 만들어서 해당 토큰을 통해 인증처리
        AjaxAuthenticationToken ajaxAuthenticationToken
                = new AjaxAuthenticationToken(accountApiRequest.getUserId(), accountApiRequest.getPassword());
